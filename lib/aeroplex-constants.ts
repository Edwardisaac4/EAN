...
export const AEROPLEX_HERO: AeroplexHeroContent = {
  ...
  lede: [
    ...
    'Under construction since June 2026.',
  ],
...
export const AEROPLEX_OVERVIEW: AeroplexOverviewContent = {
  ...
  imageAlt:
    'Airside apron and integrated facilities at EAN Aviation Lagos',
  imageCaption: 'EAN’s current operation at MMIA — the operation the campus is built around.',
};
...
export const AEROPLEX_MILESTONES: AeroplexMilestone[] = [
  {
    ...
    description: 'Ground broken on the airside site with the appointed EPC contractor.',
    state: 'complete',
  },
  {
    id: 'in-progress',
    ...
    description: 'Construction is under way. The site remains inside the airport boundary.',
    state: 'active',
  },
  {
    id: 'next',
...
export const SITE_GALLERY: AeroplexGalleryItem[] = [
  ...
  },
  {
    ...
    caption: 'Wheels and brakes work in the NCAA-approved maintenance workshop.',
    tag: 'Maintenance',
    span: 4,
  },
  {
