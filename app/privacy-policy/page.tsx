              ...
              <div className="lg:col-span-8 space-y-12">
                ...
                <SectionReveal>
                  <div className="bg-ean-navy text-ean-text-light p-8 space-y-4 shadow-lg border-l border-ean-gold">
                    ...
                    <div className="pt-2 border-t border-ean-border-dark text-xs text-ean-gold/90 font-ui italic">
                        ...
                        >
                          ...
                          {section.id === 'data-subject-rights' && (
                            <div className="bg-ean-navy text-ean-text-light p-6 space-y-4 font-ui text-xs sm:text-sm">
                              <h4 className="font-display text-lg text-ean-text-light font-light border-b border-ean-border-dark pb-2">
                          ...
                          {section.id === 'cookies' && (
                            <div className="overflow-x-auto pt-2">
                              <table className="w-full text-left border-collapse font-ui text-xs">
                                <thead>
                                  <tr className="bg-ean-navy text-ean-text-light">
              ...
              >
                ...
                {dsarSubmitted ? (
                  <div className="bg-ean-gold/10 border border-ean-gold/30 p-8 text-center space-y-4 py-12">
                    ...
                    <h4 className="font-display text-xl font-light text-ean-text-light">Request Received</h4>
                  ...
                  <form onSubmit={handleDSARSubmit} className="space-y-4 font-ui text-xs">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        className="w-full bg-ean-navy border border-ean-border-dark px-4 py-3 text-sm text-ean-text-light focus:outline-none focus:border-ean-gold cursor-pointer"
                      >
