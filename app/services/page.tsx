      ...
      <main className="flex-1 flex flex-col">
        ...
        <section className="bg-ean-surface text-ean-text-dark py-20 sm:py-24 border-b border-ean-border-light/60 relative overflow-hidden">
          ...
          <div className="max-w-ean mx-auto px-6 md:px-8 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 lg:auto-rows-fr">
                    ...
                    {config.cardType === 'wide' && (
                      ...
                      >
                        ...
                        <div className="relative h-52 sm:h-60 lg:h-auto lg:w-1/2 overflow-hidden shrink-0 min-h-55">
                          ...
                          />
                          <div
                            className={`absolute inset-0 bg-linear-to-t from-ean-obsidian via-ean-obsidian/60 to-transparent ${isImageRight
                                ? 'lg:bg-linear-to-l from-ean-obsidian/90 via-ean-obsidian/40 to-transparent'
                                : 'lg:bg-linear-to-r from-ean-obsidian/90 via-ean-obsidian/40 to-transparent'
                              }`}
                          />
                        </div>
                      ...
                      >
                        ...
                        <div className="absolute inset-0 w-full h-full overflow-hidden">
                          <Image
                            ...
                            quality={80}
                          />
                          <div className="absolute inset-0 bg-linear-to-b from-ean-obsidian/75 via-ean-obsidian/90 to-ean-obsidian" />
                        </div>
