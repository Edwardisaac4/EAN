...
export default function CampusOverview() {
  return (
    <section
      ...
      className="scroll-mt-24 bg-ean-obsidian text-ean-text-light py-16 sm:py-24 lg:py-28"
    >
      <div className="max-w-ean mx-auto px-6 md:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
        {/* Left Column: Campus Overview Copy & CTA */}
        <SectionReveal className="lg:col-span-6 space-y-6 sm:space-y-7">
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-light text-ean-text-light leading-[1.1] tracking-tight">
          ...
          <div className="pt-2">
            <Link
              ...
              className="inline-flex items-center justify-center bg-ean-gold text-ean-text-dark hover:bg-ean-gold-light transition-colors duration-300 font-ui font-semibold text-xs sm:text-sm uppercase tracking-[0.18em] px-7 py-3.5 rounded-none cursor-pointer"
            >
        ...
        <SectionReveal className="lg:col-span-6">
          <div className="border border-ean-border-dark divide-y divide-ean-border-dark bg-ean-obsidian-elevated/80 overflow-hidden">
            {AEROPLEX_FACTS.map((fact) => (
              ...
              >
                ...
                <div className="flex-1 p-5 sm:p-6 flex flex-col justify-center space-y-1.5 min-w-0">
                  ...
                  <h3 className="font-ui text-sm sm:text-base font-semibold text-ean-text-light tracking-wide">
                    {fact.value}
                  </h3>
                  <p className="font-ui text-xs text-ean-text-light/60 leading-relaxed">
                    {fact.note}
                  </p>
                </div>
              </div>
