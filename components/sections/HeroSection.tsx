    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 lg:px-12 w-full pt-20 sm:pt-22 md:pt-24 lg:pt-20 pb-12">
        <div className="max-w-2xl lg:max-w-3xl flex flex-col items-start text-left">
          ...
          <h1
            ref={titleRef}
            className="opacity-0 font-display text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-white font-medium leading-[1.1] mb-4 sm:mb-5"
          >
            {slide.title.split('\n').map((line, i) => (
          ...
          <p
            ref={subtitleRef}
            className="opacity-0 font-ui text-xs sm:text-sm md:text-base lg:text-lg text-ean-muted-light leading-relaxed mb-6 sm:mb-8 md:mb-9 max-w-xl"
          >
